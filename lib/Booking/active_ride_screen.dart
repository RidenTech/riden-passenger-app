                        ...
                        if (_sheetPosition <= 0.4) ...[
                          ...
                          _buildInfoContainer(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("locations", style: GoogleFonts.poppins(color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold)),
                                const SizedBox(height: 16),
                                IntrinsicHeight(
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                      ...
                                      SizedBox(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            // Vertical Dotted Line - Flexible
                                            Expanded(
                                              child: LayoutBuilder(
                                                builder: (context, constraints) {
                                                  const double dotHeight = 4;
                                                  const double dotSpace = 4;
                                                  final int dotCount = (constraints.maxHeight / (dotHeight + dotSpace)).floor();
                                                  return Column(
