...
import 'Complaint_Tickets/complaints_ticket.dart';
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            _buildDivider(),
                            _buildMenuRow(Icons.confirmation_number_rounded, "Complaint Tickets", menuFontSize, menuIconSize, arrowIconSize, onTap: () => Get.to(() => const ComplaintsTicketScreen())),
                            _buildDivider(),
                            _buildMenuRow(Icons.info_outline_rounded, "About Us", menuFontSize, menuIconSize, arrowIconSize, onTap: () => Get.to(() => const AboutUsScreen())),
                            _buildDivider(),
